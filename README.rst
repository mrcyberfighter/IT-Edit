    ...
    + **Configure program**: use the menu item.
        ...
        + **Terminal settings**:
            ...
            + Appearance:
                ...
                + Use a personal background image (Disabled per default).
            ...
            + Settings:
                ...
                + Select by word char (Default to: ``-A-Za-z0-9,./?%&#:_=+@~``) .
...
+ **C/C++/ObjC Header** (text/x-chdr, text/x-c++hdr)
...
+ **Matlab** (text/x-octave, text/x-matlab)
